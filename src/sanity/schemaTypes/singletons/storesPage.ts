...
export const storesPageType = defineType({
  name: "storesPage",
  title: "Mağazalar Sayfası",
  type: "document",
  groups: [
  ...
  fields: [
    defineField({
      ...
      group: "hero",
      description: "Sayfa üst kısmında duracak ana başlık (Örn: Mağazalar / Stores).",
  ...
  preview: {
    prepare() {
      return {
        title: "Mağazalar Sayfası Ayarları",
      };
    },
  },
});
