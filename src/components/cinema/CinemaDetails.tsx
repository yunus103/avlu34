        ...
        <div className="lg:col-span-7">
          <FadeIn direction="up" className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              {data.body && (
                <div className="font-sans font-light text-neutral-700 leading-relaxed text-base">
            ...
            {data.gallery && data.gallery.length > 0 && (
              <div className="flex flex-col gap-6 border-t border-neutral-200 pt-10">
            ...
            <div className="border border-neutral-200 p-8 bg-neutral-50/50 rounded-none flex flex-col gap-8">
              ...
              {data.ticketUrl && (
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 border border-black text-black bg-white hover:bg-black hover:text-white py-3.5 px-6 text-xs font-sans font-bold tracking-widest uppercase transition-all duration-300 rounded-none cursor-pointer group"
                >
                  <span>{isEn ? "VIEW SEANCES & BUY TICKETS" : "VİZYONDAKİ FİLMLER & BİLET AL"}</span>
                  <ArrowUpRight size={16} className="transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 shrink-0" />
                </a>
              )}
