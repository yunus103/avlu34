        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            ...
            {event.gallery && event.gallery.length > 0 && (
              <div className="border-t border-neutral-200 pt-8 mt-4">
                <h3 className="text-xs font-sans font-bold tracking-widest text-neutral-400 uppercase mb-6 flex items-center gap-2 select-none">
          ...
          <div className="lg:col-span-1 lg:sticky lg:top-24 select-none">
            <div className="border border-neutral-200 bg-white p-6 md:p-8 flex flex-col gap-6">
              <h3 className="text-xs font-sans font-bold tracking-widest text-neutral-400 uppercase border-b border-neutral-100 pb-3">
